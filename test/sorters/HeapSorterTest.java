...
public class HeapSorterTest {
	...
	SwapList<Integer> randomList;
	AbstractSorter<Integer> randomSorter;
	...
	public void before() {
		...
		sortedList = new ArrayBasedSwapList<Integer>(new Integer[] { 1, 2, 3,
				4, 5 });
		sortedSorter = new HeapSorter<Integer>(sortedList,
				INTEGER_COMPARATOR);
		
		randomList = new ArrayBasedSwapList<Integer>(new Integer[] {5,
				2, 4, 7, 3, 9, 1, 8, 6});//////////////////////////////////////////////////////////////////////////////////////////////
		randomSorter = new HeapSorter<Integer>(randomList,
				INTEGER_COMPARATOR);
	...
	public void testRandom(){
		SwapList<Integer> result = randomSorter.sort();
		assertTrue(result.isSorted(INTEGER_COMPARATOR));
	}
	
	@Test
	public void TestLR(){
		assertEquals(5, ((HeapSorter<Integer>) randomSorter).getLeft(2));
		assertEquals(6, ((HeapSorter<Integer>) randomSorter).getRight(2));
		assertEquals(3, ((HeapSorter<Integer>) randomSorter).getLeft(1));
		assertEquals(4, ((HeapSorter<Integer>) randomSorter).getRight(1));
	}
}
